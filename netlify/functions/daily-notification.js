...
const DUAS = [
    ...
    { title: "🤲 Dua for Protection", body: "O Allah, I seek refuge in You from worry and grief, weakness and laziness, cowardice and miserliness." },
    { title: "🤲 Dua for Patience", body: "O Allah, grant me patience, make my footsteps firm, and help me against those who oppose the truth." },
    { title: "🤲 Dua for Knowledge", body: "O Allah, benefit me with what You have taught me, teach me what will benefit me, and increase me in knowledge." },
    { title: "🤲 Dua for Parents", body: "My Lord, have mercy upon my parents as they brought me up when I was small." },
    { title: "🤲 Dua of Prophet Yunus", body: "There is no deity except You; exalted are You. Indeed, I have been of the wrongdoers." },
    { title: "🤲 Dua for Anxiety", body: "O Allah, I am Your servant, my forelock is in Your hand. Your judgment upon me is assured, Your decree fair." },
    { title: "🤲 Dua for Steadfastness", body: "Our Lord, do not let our hearts deviate after You have guided us, and grant us mercy from Yourself." },
    { title: "🤲 Dua for Good End", body: "O Allah, make the best of my life its end, the best of my deeds their conclusion, and the best of my days the Day I meet You." },
    { title: "🤲 Dua for Heart", body: "O Turner of hearts, make my heart firm upon Your religion." },
    { title: "🤲 Dua for This World & Hereafter", body: "Our Lord, give us good in this world and good in the Hereafter, and protect us from the punishment of the Fire." },
    { title: "🤲 Dua for Tawakkul", body: "Allah is sufficient for me. There is no deity except Him. Upon Him I have relied, and He is Lord of the Great Throne." },
    { title: "🤲 Dua for Mercy", body: "O Allah, I ask You for Your mercy by virtue of which You guide hearts and bring together scattered affairs." },
    { title: "🤲 Dua for Barakah", body: "O Allah, bless us in our hearing, our sight, our hearts, our spouses, and our offspring." },
    { title: "🤲 Dua for Protection from Evil", body: "I seek refuge in the perfect words of Allah from the evil of what He has created." },
    { title: "🤲 Dua for Istighfar", body: "I seek forgiveness from Allah, there is no god but He, the Living, the Eternal, and I turn to Him in repentance." },
    { title: "🤲 Dua for Good Character", body: "O Allah, make my character good just as You have made my creation good." },
    { title: "🤲 Dua of Ibrahim", body: "My Lord, make me an establisher of prayer, and from my descendants. Our Lord, accept my supplication." },
    { title: "🤲 Dua for Ummah", body: "O Allah, forgive the believing men and women, the Muslim men and women, the living and the dead." },
    ...
    { title: "🤲 Dua for Taqwa", body: "O Allah, grant my soul its taqwa and purify it, You are the best to purify it, You are its Guardian and Master." },
    { title: "🤲 Dua for Sincerity", body: "O Allah, I seek refuge in You from associating anything with You knowingly, and I seek Your forgiveness for what I do unknowingly." },
    { title: "🤲 Dua of Musa", body: "My Lord, expand for me my chest, ease for me my task, and untie the knot from my tongue." },
    { title: "🤲 Dua for Beneficial Knowledge", body: "O Allah, I ask You for beneficial knowledge, good provision, and accepted deeds." },
    { title: "🤲 Dua for Paradise", body: "O Allah, I ask You for Paradise and whatever brings me closer to it of words and deeds." },
    { title: "🤲 Dua for Protection from Hellfire", body: "O Allah, I seek refuge in You from the Hellfire and whatever brings me closer to it of words and deeds." },
    { title: "🤲 Dua for Well-being", body: "O Allah, I ask You for well-being in this world and the next. I ask You for pardon and well-being in my religion, family, and wealth." },
    { title: "🤲 Dua for Night of Power", body: "O Allah, You are Forgiving and love forgiveness, so forgive me." },
    { title: "🤲 Dua for Best Ending", body: "O Allah, make the best of my life its last portion, the best of my deeds their final ones, and the best of my days the Day I meet You." }
];
